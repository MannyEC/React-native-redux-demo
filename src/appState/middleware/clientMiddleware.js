...
import { SHOW_ERROR, PERMISSION_DENIDE } from 'redux/modules/GlobalTips';
        ...
        (res) => {
          ...
          switch (statusCode) {
            ...
            case 401:
              ...
              break;
            case 403:
              next({ ...rest, error, statusCode, type: PERMISSION_DENIDE });
              break;
            case 500:
              next({ ...rest, error, statusCode, type: FAILURE });
              break;
            case 501:
              next({ ...rest, error: error.errors, statusCode, type: SHOW_ERROR });
